...
<div style="width: 100%;height: auto;">
      <div style="width: 50%; height: auto; background-color: rgb(217, 217, 234);margin: auto;padding: 20px">
        <form method="POST" action="{{ url("editCart/$product->id") }}">
            @csrf
            <div style="width: 100%;height:auto;background-color: rgb(219, 207, 207); padding: 10px">
             ...
             <a href="#"><img  src="{{ str_replace(public_path().'',"",$product->img) }}" alt="" style ="width:100%" /></a>
                </div>
                <div style="width: 100%;height: auto;background-color: rgb(183, 183, 176);padding: 20px;margin: auto">
                    <a href="#"><h2 style="font-weight: bold; margin-bottom: 5px">{{ $product->title }}</h2></a>

                  <h4 style="font-weight: bold;margin-bottom: 5px">price: {{ $product->price }}</h4>

                   <h5 style="font-weight: bold;">Brand: {{ $product->desc }}</h5>
